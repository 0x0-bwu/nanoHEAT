...
int main()
{
    nano::SetCurrentDir(generic::fs::DirName(__FILE__).string() + "/../../test/data/package/tinytapeout-demo");
    Database::Create("tinytapeout-demo");
    ...
    Vec<Float>{TempUnit(25).inKelvins()}, Vec<Float>{1});
